...
namespace AdvancedProgramming_Lesson1.Controllers
{
    public class MeatsController : Controller
    {
        ...
        public MeatsController(MvcMovieContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TypeOfMeat,ExpiryDate,Weight,Fat,Price")] Meat meat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TypeOfMeat,ExpiryDate,Weight,Fat,Price")] Meat meat)
        {
            if (id != meat.Id)
            {
                return NotFound();
